...
export const de: Record<string, string> = {
  ...
  'Search people by name, role, or skill…': 'Personen nach Name, Rolle oder Fähigkeit suchen…',
  'No people match your search.': 'Keine Personen passen zu deiner Suche.',
  Showing: 'Zeige',
  of: 'von',
  'search to narrow down.': 'suche, um einzugrenzen.',
  edit: 'bearbeiten',
  ...
  Dashboard: 'Dashboard',
  Overview: 'Übersicht',
  'Everything at a glance — totals and money, calculated for you from the live data.':
    'Alles auf einen Blick — Summen und Zahlen, aus den Live-Daten für dich berechnet.',
  Decisions: 'Entscheidungen',
  Records: 'Datensätze',
  'key people': 'Schlüsselpersonen',
  terms: 'Begriffe',
  Readiness: 'Reife',
  'Revenue & customers': 'Umsatz & Kunden',
  'Annual recurring revenue (ARR)': 'Jährlich wiederkehrender Umsatz (ARR)',
  'recurring customer contracts': 'wiederkehrende Kundenverträge',
  'Total contract value': 'Gesamter Vertragswert',
  'incl. one-off': 'inkl. einmalig',
  Customers: 'Kunden',
  'at risk': 'gefährdet',
  'at-risk': 'gefährdet',
  'Average contract': 'Durchschnittlicher Vertrag',
  'Contract value by renewal year': 'Vertragswert nach Verlängerungsjahr',
  ...
  // ── Legal: license gate, footer, disclaimers ──────────────
  '✨ Generated by Hermes (AI) — may be inaccurate; review before relying.':
    '✨ Erstellt von Hermes (KI) — kann ungenau sein; vor dem Verlassen darauf prüfen.',
  'This readiness score is a document-completeness heuristic — not a valuation or financial, investment, or legal advice. Figures are user-entered and unaudited.':
    'Dieser Bereitschafts-Score ist eine Heuristik zur Dokumentvollständigkeit — keine Bewertung und keine Finanz-, Anlage- oder Rechtsberatung. Die Zahlen sind nutzereingegeben und ungeprüft.',
  'Before you continue': 'Bevor Sie fortfahren',
  'By using ADAMAS you agree to the Terms of Use, Privacy Policy and End-User License Agreement.':
    'Mit der Nutzung von ADAMAS stimmen Sie den Nutzungsbedingungen, der Datenschutzerklärung und dem Endbenutzer-Lizenzvertrag zu.',
  'ADAMAS is proprietary software, licensed and not sold. All intellectual property and rights in the software remain with':
    'ADAMAS ist proprietäre Software, die lizenziert und nicht verkauft wird. Sämtliche geistigen Eigentums- und sonstigen Rechte an der Software verbleiben bei',
  'The software is provided “as is”, without warranties of any kind. AI-generated content and the valuation-readiness score are not professional legal, financial, or investment advice. [TODO: counsel]':
    'Die Software wird „wie besehen“ ohne jegliche Gewährleistung bereitgestellt. KI-generierte Inhalte und der Bewertungs-Bereitschafts-Score sind keine professionelle Rechts-, Finanz- oder Anlageberatung. [TODO: counsel]',
  'Terms of Use': 'Nutzungsbedingungen',
  'Privacy Policy': 'Datenschutzerklärung',
  'End-User License Agreement': 'Endbenutzer-Lizenzvertrag',
  'I accept': 'Ich stimme zu',
  'All rights reserved.': 'Alle Rechte vorbehalten.',
  'ADAMAS is licensed, not sold.': 'ADAMAS wird lizenziert, nicht verkauft.',
  'local-first by default': 'standardmäßig lokal-zuerst',
  'Local-first by default — features you enable (cloud AI, Gmail labeling, email/calendar connectors) transmit data to services you choose.':
    'Standardmäßig lokal-zuerst — von Ihnen aktivierte Funktionen (Cloud-KI, Gmail-Kennzeichnung, E-Mail-/Kalender-Konnektoren) übertragen Daten an die von Ihnen gewählten Dienste.',
  'Local-first by default — features you enable (cloud AI, Gmail labeling, email/calendar connectors) transmit data to services you choose. A cloud route is opt-in per task: you see exactly what would be transmitted before anything is sent.':
    'Standardmäßig lokal-zuerst — von Ihnen aktivierte Funktionen (Cloud-KI, Gmail-Kennzeichnung, E-Mail-/Kalender-Konnektoren) übertragen Daten an die von Ihnen gewählten Dienste. Ein Cloud-Weg ist pro Aufgabe freiwillig: Sie sehen genau, was übertragen würde, bevor etwas gesendet wird.',
  'These values reflect the default configuration. Enabling optional features (cloud AI, Gmail labeling, email/calendar connectors) transmits data to the services you choose.':
    'Diese Werte spiegeln die Standardkonfiguration wider. Das Aktivieren optionaler Funktionen (Cloud-KI, Gmail-Kennzeichnung, E-Mail-/Kalender-Konnektoren) überträgt Daten an die von Ihnen gewählten Dienste.',
};
